...
import { ArrowRight, Lock, Mail, ShieldAlert, Building, User } from 'lucide-react';
                ...
                <div className="bg-white border-4 border-black p-8 md:p-10 neo-shadow -rotate-1">
                    <div className="text-center mb-8">
                        <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-2">
                            Join <span className="text-orange-500 font-caveat text-5xl md:text-6xl lowercase tracking-normal">us!</span>
                        </h1>
                        <p className="text-lg font-bold bg-green-200 border-2 border-black inline-block px-3 py-1 rotate-2 neo-shadow-sm">
                            Create your Tenant
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col gap-2">
                                <label className="font-black uppercase flex items-center gap-2 text-lg">
                                    <Building size={20} /> Organization Name
                                </label>
                                <input
                                    required
                                    type="text"
                        ...
                        <p className="text-center font-bold text-sm mt-2">
                            ...
                            <Link href="/login" className="text-orange-600 hover:text-orange-500 underline decoration-2 underline-offset-2">
                                Log in here
                            </Link>
                        </p>
                    </form>
